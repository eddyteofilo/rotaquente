  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6 py-12">
      <motion.div 
        ...
        className="glass-card max-w-lg w-full p-8 rounded-sm relative overflow-hidden"
      >
        <div className="absolute top-0 left-0 w-full h-1 bg-accent" />
        
        <header className="mb-8 text-center">
          <CheckCircle2 className="w-12 h-12 text-accent mx-auto mb-4" />
          <h2 className="text-3xl font-bold tracking-tighter uppercase mb-2">Pedido Entregue!</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            ...
            className="w-full bg-accent text-white font-bold py-4 rounded-sm hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-3 mt-4 disabled:opacity-50"
          >
            {isSubmitting ? (
